...
%     keyboard
    ...
    % Correct Image Categories 
    D.realImageCategory(D.currImageCategory==1 || D.currImageCategory==3 || D.currImageCategory==5)=1 %%1 for animal 
    D.realImageCategory(D.currImageCategory==2 || D.currImageCategory==4 || D.currImageCategory==6)=2 %%2 for object
    
    %% Congruency 
    D.CongruentOrNot(D.realImageCategory==D.currWordCategory)=1; %% 1 when congruent
    D.CongruentOrNot(D.realImageCategory~=D.currWordCategory)=2; %% 2 when incongruent
